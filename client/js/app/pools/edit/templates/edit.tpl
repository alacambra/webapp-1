        ...
        <div class="row">
            <div class="col-md-4 col-lg-4">
                <div class="form-group">
                    ...
                    <input id="js-pool-name" type="text" name="name" value="<%= name %>" class="form-control">
                </div>

                <div class="form-group">
                    <label class="control-label" for="js-pool-description"><%= I18n.t('pool.label.description') %></label>
                    <textarea id="js-pool-description" name="description" class="form-control resize-vertical" rows="4"><%= description %></textarea>
                </div>
            </div>
