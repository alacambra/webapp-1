define(['app', 'config', 'app/entities/effort', 'app/entities/project', 'app/validation_helper', 'backbone_faux_server'], function(App, CONFIG, Entities, EntitiesProject, validation_helper, Faux) {
