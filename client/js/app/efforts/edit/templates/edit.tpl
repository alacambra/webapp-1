<ol class="breadcrumb">
    ...
    <li><a class="js-task" href="#tasks/<%= task_id %>"><%= I18n.t('main_navi.task') %></a></li>
    <li><a class="js-efforts" href="#tasks/<%= task_id %>/efforts"><%= I18n.t('main_navi.efforts') %></a></li>
    <% if (Backbone.history.location.hash.indexOf('new') < 0) { %>
    <li><a class="js-effort" href="#efforts/<%= id %>"><%= I18n.t('main_navi.effort') %></a></li>
    <% } %>
